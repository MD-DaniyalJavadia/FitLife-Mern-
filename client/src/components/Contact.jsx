        ...
        >
          ...
          >
            ...
            <p style={{ display: "flex", alignItems: "center", gap: "8px" }}>
              ...
              APWA Complex, 1st Floor, Agha Khan 3 Rd, Garden East Saddar Town,
              Karachi, Sindh 74400, Pakistan
            </p>

            <p style={{ display: "flex", alignItems: "center", gap: "8px" }}>
              <IonIcon icon={callSharp} aria-hidden="true" />
              <a
                href="tel:18001213637"
                style={{ color: "#ff4d1a", textDecoration: "none" }}
              >
                1800-121-3637
              </a>
              ,&nbsp;
            ...
            <p style={{ display: "flex", alignItems: "center", gap: "8px" }}>
              <IonIcon icon={mailSharp} aria-hidden="true" />
              <a
